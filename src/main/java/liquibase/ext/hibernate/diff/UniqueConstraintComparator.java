...
public class UniqueConstraintComparator implements DatabaseObjectComparator {
	...
	public boolean isSameObject(DatabaseObject databaseObject1,
		...
		String uniqueConstraint1String = uniqueConstraint1.getTable().getName()
				+ "(" + uniqueConstraint1.getColumnNames() + ")";
		String uniqueConstraint2String = uniqueConstraint2.getTable().getName()
				+ "(" + uniqueConstraint2.getColumnNames() + ")";

		if (accordingTo.isCaseSensitive())
			return uniqueConstraint1String.equals(uniqueConstraint2String);
		else
			return uniqueConstraint1String
					.equalsIgnoreCase(uniqueConstraint2String);
	}
	...
	public ObjectDifferences findDifferences(DatabaseObject databaseObject1,
		...
		if (databaseObject1.getAttribute("hibernate", String.class) == null
			...
			return chain.findDifferences(databaseObject1, databaseObject2,
					accordingTo);
		ObjectDifferences differences = chain.findDifferences(databaseObject1,
				databaseObject2, accordingTo);
