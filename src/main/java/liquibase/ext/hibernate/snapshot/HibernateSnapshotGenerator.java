...
public abstract class HibernateSnapshotGenerator implements SnapshotGenerator {
	...
	protected HibernateSnapshotGenerator(
			Class<? extends DatabaseObject> defaultFor) {
	...
	public final int getPriority(Class<? extends DatabaseObject> objectType,
			Database database) {
	...
	public final DatabaseObject snapshot(DatabaseObject example,
	...
	protected org.hibernate.mapping.Table findHibernateTable(
